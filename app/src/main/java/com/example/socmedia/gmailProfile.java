...
public class gmailProfile extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (settings_save.getString("gmail_saved", "").toString().equals("gmail_saved")) {
            ...
            Picasso.get().load(sharedPreferences.getString(EmailprofileUrl, "")).placeholder(R.drawable.profileuser).into(circleImageView);
        ...
        if(account != null) {
            ...
            Picasso.get().load(Pemail_profileUrl).placeholder(R.drawable.profileuser).into(circleImageView);
