...
public class MainActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener{
    ...
    SignInButton gmail_loginButton;
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        //fb_loginButton.setText("Continue with Facebook");

        fb_loginButton = findViewById(R.id.login_buttonfb);
        ...
        gmail_loginButton = findViewById(R.id.sign_in_buttongoogle);
