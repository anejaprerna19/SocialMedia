...
public class Home  extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Picasso.get().load(Pfb_profileUrl).placeholder(R.drawable.profileuser).into(circleImageView);
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder builder_exitbutton = new AlertDialog.Builder(Home.this);
                builder_exitbutton.setTitle("Really Logout?")
                        ...
                        .setPositiveButton("yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                Toast.makeText(Home.this, "Facebook Logged out successfully!", Toast.LENGTH_SHORT).show();
